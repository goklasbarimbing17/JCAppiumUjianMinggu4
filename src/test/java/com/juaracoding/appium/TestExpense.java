...
import com.juaracoding.appium.pages.ExpensePage;
...
public class TestExpense {
    ...
    public void addExpanceValid(){
        ...
        expensePage.setAmount("10000");
        expensePage.setNotes("Pengeluaran pulsa 10,000");
        expensePage.clickBtnSave();
        //step Validation
        Assert.assertTrue(expensePage.getTextCategory().contains("Pulsa"));
        Assert.assertTrue(expensePage.getTextAmount().contains("10.000"));
        Assert.assertTrue(expensePage.getTextNotes().contains("Pengeluaran pulsa 10,000"));
        delay(2);
    }
    @AfterClass
