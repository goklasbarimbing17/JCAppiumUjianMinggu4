...
public class ExpensePage {
    ...
    By categoryPulsa = By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[8]/android.widget.LinearLayout/android.widget.TextView");
    By category = By.id("com.chad.financialrecord:id/spCategory");
    By pickDate = By.xpath("//android.view.View[@content-desc=\"04 Maret 2023\"]");
    ...
    By dateExpance = By.id("com.chad.financialrecord:id/tvDate");
